...
export const Modal: React.FC<ModalProps> = ({
  ...
  return (
    <>
      <div className="justify-center items-center z-50 inset-0 flex fixed overflow-x-hidden overflow-y-auto outline-none focus:outline-none bg-neutral-800 bg-opacity-70">
        <div className="relative w-full lg:w-3/6 lg:max-w-3xl my-6 mx-auto h-full lg:h-auto">
          {/* Content */}
